  ...
  <div class="container">
    ...
    <div class="main-content">
      ...
      <div class="left-main">
        ...
        <a class="catalogue-slim" id="cts1" href="picfromgermany.php">
      ...
      <div class="right-main">
        <?php 
          ...
          $pattern=array("03","13","14","19","23","25","26","45","46","51");
          foreach($files as $file) {
            if (in_array(substr($file, 0, -4), $pattern)){
              $images[] = $file;
            }
          }
          ...
          foreach($images as $image){
            ...
            echo '<img id="g-img" class = "thumbnail" src='.$dir.$image.'  alt="'.$caption[(int)$pattern[$i]].'"/>';
            echo'</div>';
            $i++;
          }
        ?>
